...
if __name__ == "__main__" :
	...
	enterTask = Label(gui, text = "Enter Your Task:", bg = "dark slate gray")
	...
	Submit = Button(gui, font = "lucida 13", text = "Submit", fg = "Black", bg = "blue",activebackground='red', command = insertTask)
	...
	taskNumber = Label(gui, text = "Delete Task Number:", bg = "dark slate gray")
						
	taskNumberField = Text(gui,padx=5,pady=5,height = 1, width = 2, font = "lucida 13")

	# create a Delete Button and place into the root window
	# when user press the button, the command or 
	# function affiliated to that button is executed .
	delete = Button(gui,padx=5, pady=5, text = "Delete", fg = "Black", bg = "dark green", activebackground="red", command = delete)
